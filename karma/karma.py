...
from karmaapi.node import KarmaNodeRPC
...
class Karma(object):
    """ Connect to the karma network.
        ...
        * **Wallet Database**: Here, the karmalibs load the keys from the
          locally stored wallet SQLite database (see ``storage.py``).
          To use this mode, simply call ``karma()`` without the
          ``keys`` parameter
        * **Providing Keys**: Here, you can provide the keys for
          your accounts manually. All you need to do is add the wif
          keys for the accounts you want to use as a simple array
          using the ``keys`` parameter to ``karma()``.
        * **Force keys**: This more is for advanced users and
        ...
        http://KARMA-node.bitshares.eu. It is **highly** recommended that you pick your own
        ...
        All that is requires is for the user to have added a key with ``karma``
        ...
        .. code-block:: bash
            ...
            karma set default_account xeroc
    ...
    def __init__(self,
        ...
        self.txbuffer = TransactionBuilder(karma_instance=self)
    ...
    def connect(self,
        ...
        self.rpc = KarmaNodeRPC(node, rpcuser, rpcpassword, **kwargs)
    ...
    def sign(self, tx=None, wifs=[]):
        ...
        """
        if tx:
            txbuffer = TransactionBuilder(tx, karma_instance=self)
        else:
    ...
    def broadcast(self, tx=None):
        """ Broadcast a transaction to the karma network
    ...
    def create_account(
        ...
        if not registrar:
            raise ValueError(
                ...
                "registrar=x, or set the default_account using 'karma'")
        ...
        try:
            Account(account_name, karma_instance=self)
            raise AccountExistsException
        except:
            pass

        referrer = Account(referrer, karma_instance=self)
        registrar = Account(registrar, karma_instance=self)

        " Generate new keys from password"
        from karmabase.account import PasswordKey, PublicKey
        if password:
        ...
        for k in additional_owner_accounts:
            addaccount = Account(k, karma_instance=self)
        ...
        # voting account
        voting_account = Account(proxy_account or "proxy-to-self", karma_instance=self)
    ...
    def transfer(self, to, amount, asset, memo="", account=None):
        ...
        account = Account(account, karma_instance=self)
        amount = Amount(amount, asset, karma_instance=self)
        to = Account(to, karma_instance=self)
    ...
    def allow(self, foreign, weight=None, permission="active",
        ...
        try:
            ...
            try:
                foreign_account = Account(foreign, karma_instance=self)
    ...
    def approvewitness(self, witnesses, account=None):
        ...
        for witness in witnesses:
            witness = Witness(witness, karma_instance=self)
    ...
    def approvecommittee(self, committees, account=None):
        ...
        for committee in committees:
            committee = Committee(committee, karma_instance=self)
    ...
    def cancel(self, orderNumber, account=None):
        ...
        if not account:
            raise ValueError("You need to provide an account")
        account = Account(account, full=False, karma_instance=self)
    ...
    def approveproposal(self, proposal_ids, account=None, approver=None):
        ...
        for proposal_id in proposal_ids:
            proposal = Proposal(proposal_id, karma_instance=self)
    ...
    def betting_market_create(
        ...
        """ Create an event group. This needs to be **proposed**.
            ...
            :param karma.asset.Asset asset: Asset to be used for this market
