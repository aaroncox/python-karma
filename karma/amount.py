...
class Amount(dict):
    """ This class deals with Amounts of any asset to simplify dealing with the tuple::
        ...
        Way to obtain a proper instance:
            ...
            * ``args`` can be a list of a ``float`` and a :class:`karma.asset.Asset`
        ...
        An instance is a dictionary and comes with the following keys:
            ...
            * ``amount`` (float)
            * ``symbol`` (str)
            * ``asset`` (instance of :class:`karma.asset.Asset`)
    ...
    @property
    def asset(self):
        """ Returns the asset as instance of :class:`karma.asset.Asset`
        """
        if not self["asset"]:
            self["asset"] = Asset(self["symbol"], karma_instance=self.karma)
        return self["asset"]
