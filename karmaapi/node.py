...
from karmabase.chains import known_chains
from . import exceptions
import logging
log = logging.getLogger(__name__)


class KarmaNodeRPC(GrapheneWebsocketRPC):

    def __init__(self, *args, **kwargs):
        super(KarmaNodeRPC, self).__init__(*args, **kwargs)
    ...
    def rpcexec(self, payload):
        """ Execute a call by sending the payload.
            ...
            In here, we mostly deal with karma specific error handling
        ...
        try:
            ...
            return super(KarmaNodeRPC, self).rpcexec(payload)
