...
.. code-block:: python
    ...
    KARMA = KarmaNodeRPC("wss://hostname")
    print(KARMA.get_account_by_name("init0"))
    print(KARMA.get_block(1))
...
.. code-block:: python
   ...
   from karmaapi.wallet import KarmaWalletRPC
   rpc = KarmaWalletRPC("localhost", 8090)
   print(rpc.info())
