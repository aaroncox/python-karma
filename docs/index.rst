.. python-karma documentation master file, created by
...
Welcome to pykarma's documentation!
===============================================

karma is a **blockchain-based autonomous company** (i.e. a DAC) that
...
solution. In case of karma, it comes with karmaralized gaming
engine and allows setting up and running tournaments of any kind.

About this Library
------------------

The purpose of *pykarma* is to simplify development of products and
services that use the karma blockchain. It comes with
...
.. code-block:: python
   ...
   karma = karma()
   karma.wallet.unlock("wallet-passphrase")
   karma.transfer("<to>", "<amount>", "<asset>", ["<memo>"], account="<from>")
